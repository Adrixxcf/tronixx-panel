...
/* ── AUTO "CORTE PENDIENTE": cuando ya venció y tú no has hecho nada ── */
...
function renderVentas() {
  ...
  if (!slice.length) {
    ...
    tbody.innerHTML = slice.map(v => {
      ...
      // Botón renovar: aparece en Corte pendiente y Corte
      const renovarBtn = (v.estado==='Corte pendiente' || v.estado==='Corte')
        ...
        : '';
      // Botón corte manual: aparece solo en "Corte pendiente" para confirmar que ya hiciste el corte
