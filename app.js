/* ═══════════════════════════════════════════════
   ...
   app.js  (versión Firebase — sincronización en la nube)
   ═══════════════════════════════════════════════ */
...
/* ══════════════════════════════════
   ...
   (copiada de tu proyecto tronixx-panel)
   ══════════════════════════════════ */
...
const COL = "ventas"; // nombre de la colección en Firestore
...
let page     = 0;
const PAGE_SIZE = 10;
let editId   = null;   // ID del documento Firestore que se está editando
...
/* ══════════════════════════════════
   ...
   Cualquier cambio en Firestore actualiza
   la pantalla al instante en todos los dispositivos
   ══════════════════════════════════ */
function startRealtimeSync() {
  ...
  onSnapshot(q,
    (snapshot) => {
      ...
      // Habilitar botón de nueva venta una vez conectado
...
/* ══════════════════════════════════
   GUARDAR — agrega o actualiza en Firestore
   ══════════════════════════════════ */
...
/* ══════════════════════════════════
   ELIMINAR — borra el documento de Firestore
   ══════════════════════════════════ */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Deshabilitar "Nueva Venta" hasta que Firebase esté conectado
  const btnNew = document.querySelector('.btn-new');
